...
%\lhead{\includegraphics[width=2.0in]{PLOS-submission.jpg}}
...
\begin{flushleft}
{\Large
\textbf\newline{Multi-channel cross-correlation analyses of a electroencephalogram (EEG) experiment recordings using \dmc} % Please use "sentence case" for title and headings (capitalize only the first word in a title (or heading), the first word in a subtitle (or subheading), and any proper nouns).
}
\newline
...
\includegraphics[width=.9\textwidth]{../output/figs/stats/S014.eps}
